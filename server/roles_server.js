...
Meteor.startup(function () {
  ...
  if (App.collections.Secrets.find().fetch().length === 0) {
    App.collections.Secrets.insert({secret:"ec2 password: apple2"});
    App.collections.Secrets.insert({secret:"domain registration pw: apple3"});
  }
